...
public class BaseMenuDrawer implements ListView.OnItemClickListener{
	...
	public BaseMenuDrawer(Context context, View listview) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (position == menuItemsList.size()) {
			...
			evt.onListItemClick(listView, view, id);
		}
	}
	...
	private void switchFragment(Fragment fragment) {
		if (activity == null)
			return;
		if (activity instanceof BaseDrawerFragmentsActivity && fragment != null) {
			BaseDrawerFragmentsActivity fca = (BaseDrawerFragmentsActivity) activity;
			fca.setActualFragment(fragment);
		} else if (activity instanceof BaseDrawerFragmentsActivity
				&& fragment == null) {
			BaseDrawerFragmentsActivity fca = (BaseDrawerFragmentsActivity) activity;
			fca.close();
		}
